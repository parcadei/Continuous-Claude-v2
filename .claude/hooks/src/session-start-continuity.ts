 ...
 */
export function buildHandoffDirName(
  sessionName: string,
  sessionId: string,
): string {
 ...
 */
export function parseHandoffDirName(dirName: string): {
  sessionName: string;
 ...
 */
export function findSessionHandoffWithUUID(
  sessionName: string,
  sessionId: string,
): string | null {
