...
class DocGrepParams(BaseModel):
    """Parameters for doc_grep"""
...
async def doc_grep(params: DocGrepParams) -> Dict[str, Any]:
    """
    ...
    # Call tool
    result = await call_mcp_tool("nia__doc_grep", params.model_dump(exclude_none=True))
