...
### 2b. Fourth Executive (v2 — Premium Depth Recovery)

**Vibe:** Premium dark with Fourth brand DNA, warm/cool glow variety, near-black depth

**Typography:**
- Display: `Poppins` (600) -- Fourth brand, geometric sans-serif
- Body: `Poppins` (400/500) -- Consistent brand identity
...
:root {
    ...
    --bg-tertiary: #153650;      /* Hover/active (L=20%) */
    --bg-midnight: #051526;      /* Deepest dark (L=7%) */
    --text-primary: #FFFFFF;
    --text-secondary: #CFD1D1;   /* Fourth Cool Grey */
    --accent: #6FB4E3;           /* Sky Blue — PRIMARY accent (labels, bullets, th) */
    --teal: #00B69F;             /* Teal — SECONDARY accent (accent lines, nav dots) */
    --sunrise: #FAA51A;          /* Sunrise Orange — warm accent (brand tertiary) */
    --purple: #9678B6;           /* Fourth Purple (corrected) */
    --danger: #D81632;           /* Fourth Hot Red (corrected) */
}
```

**Signature Elements:**
- Dark gradient title/closing slides (deepest midnight → Fourth Midnight → dark card)
- Base64-embedded Fourth logos (white on dark, standard on light)
- iQ icon mark on section breaks
- 4-color glow rotation across slides: teal → sunrise → purple → sky
- Section breaks use Deep Blue `#0C4A7D` radial glow (mid-tone contrast)
- Sky Blue as default accent; Teal reserved for accent lines and nav dots
- Sunrise Orange warm radial glows (brand-compliant warmth, HSL 39)
- Denser glass cards: `rgba(15,42,63,0.55)` on near-black body

**Animation Style:**
- Fast, subtle (0.3-0.5s)
- Fade + translateY reveals with stagger
- Professional restraint, matching Midnight Executive

**When to Use:**
- Default for all Fourth-branded presentations
- EBR/QBR decks, sales presentations, partner reviews
- Any deck requiring Fourth brand compliance
...
| Fourth Brand | Poppins | Poppins | Google |
