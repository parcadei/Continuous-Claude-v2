# UI Audit: Complete Rule Catalog

100+ rules from Vercel Web Interface Guidelines. All 14 categories with BAD/GOOD examples.
...
#### typo-ellipsis
**Rule**: Use proper ellipsis (…) not three dots (...).
...
**Rule**: Loading states end with ellipsis (Loading…).
